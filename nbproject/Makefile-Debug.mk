...
${OBJECTDIR}/IO_Channel_AccesWrapper.o: IO_Channel_AccesWrapper.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IO_Channel_AccesWrapper.o IO_Channel_AccesWrapper.cpp
...
${OBJECTDIR}/regReplaceExtension.o: regReplaceExtension.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/regReplaceExtension.o regReplaceExtension.cpp
...
${OBJECTDIR}/src/ChannelEntitys/Channel_Entities_PiFace.o: src/ChannelEntitys/Channel_Entities_PiFace.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ChannelEntitys/Channel_Entities_PiFace.o src/ChannelEntitys/Channel_Entities_PiFace.cpp

${OBJECTDIR}/src/ChannelEntitys/Channel_Entity.o: src/ChannelEntitys/Channel_Entity.cpp
	${MKDIR} -p ${OBJECTDIR}/src/ChannelEntitys
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ChannelEntitys/Channel_Entity.o src/ChannelEntitys/Channel_Entity.cpp

${OBJECTDIR}/src/ChannelEntitys/Channel_Entity_Memory.o: src/ChannelEntitys/Channel_Entity_Memory.cpp
	${MKDIR} -p ${OBJECTDIR}/src/ChannelEntitys
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ChannelEntitys/Channel_Entity_Memory.o src/ChannelEntitys/Channel_Entity_Memory.cpp

${OBJECTDIR}/src/ChannelEntitys/Channel_Entity_TimerOutput.o: src/ChannelEntitys/Channel_Entity_TimerOutput.cpp
	${MKDIR} -p ${OBJECTDIR}/src/ChannelEntitys
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ChannelEntitys/Channel_Entity_TimerOutput.o src/ChannelEntitys/Channel_Entity_TimerOutput.cpp

${OBJECTDIR}/src/ChannelEntitys/Channel_Entity_TimerTrigger.o: src/ChannelEntitys/Channel_Entity_TimerTrigger.cpp
	${MKDIR} -p ${OBJECTDIR}/src/ChannelEntitys
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ChannelEntitys/Channel_Entity_TimerTrigger.o src/ChannelEntitys/Channel_Entity_TimerTrigger.cpp

${OBJECTDIR}/src/IOChannels/IO_Channel.o: src/IOChannels/IO_Channel.cpp
	${MKDIR} -p ${OBJECTDIR}/src/IOChannels
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/IOChannels/IO_Channel.o src/IOChannels/IO_Channel.cpp

${OBJECTDIR}/src/IOChannels/IO_Channel_Hw.o: src/IOChannels/IO_Channel_Hw.cpp
	${MKDIR} -p ${OBJECTDIR}/src/IOChannels
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/IOChannels/IO_Channel_Hw.o src/IOChannels/IO_Channel_Hw.cpp

${OBJECTDIR}/src/IOChannels/IO_Channel_Hw_PiFace.o: src/IOChannels/IO_Channel_Hw_PiFace.cpp
	${MKDIR} -p ${OBJECTDIR}/src/IOChannels
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/IOChannels/IO_Channel_Hw_PiFace.o src/IOChannels/IO_Channel_Hw_PiFace.cpp

${OBJECTDIR}/src/IOChannels/IO_Channel_Virtual.o: src/IOChannels/IO_Channel_Virtual.cpp
	${MKDIR} -p ${OBJECTDIR}/src/IOChannels
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/IOChannels/IO_Channel_Virtual.o src/IOChannels/IO_Channel_Virtual.cpp

${OBJECTDIR}/src/IOChannels/IO_Channel_Virtual_Memory.o: src/IOChannels/IO_Channel_Virtual_Memory.cpp
	${MKDIR} -p ${OBJECTDIR}/src/IOChannels
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/IOChannels/IO_Channel_Virtual_Memory.o src/IOChannels/IO_Channel_Virtual_Memory.cpp

${OBJECTDIR}/src/IOChannels/IO_Channel_Virtual_Pipe.o: src/IOChannels/IO_Channel_Virtual_Pipe.cpp
	${MKDIR} -p ${OBJECTDIR}/src/IOChannels
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/IOChannels/IO_Channel_Virtual_Pipe.o src/IOChannels/IO_Channel_Virtual_Pipe.cpp
